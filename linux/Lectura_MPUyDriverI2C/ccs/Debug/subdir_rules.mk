...
mi_driver_I2C.obj: ../mi_driver_I2C.c $(GEN_OPTS) $(GEN_SRCS)
	@echo 'Building file: $<'
	@echo 'Invoking: ARM Compiler'
	"/opt/ti/ccsv5/tools/compiler/tms470_4.9.5/bin/cl470" -mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me -g --include_path="/opt/ti/ccsv5/tools/compiler/tms470_4.9.5/include" --include_path= --define=PART_LM4F120H5QR --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="mi_driver_I2C.pp" $(GEN_OPTS__FLAG) "$(shell echo $<)"
	@echo 'Finished building: $<'
	@echo ' '
